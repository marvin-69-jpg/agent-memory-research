...
├── wiki/                          LLM 維護的 entity pages（61 pages）
├── reports/                       自主研究報告（每日一篇）
├── schema/                        wiki 格式規則
├── tools/
│   ├── memory.py                  記憶管理 CLI
...
GBrain, Letta, MemGPT, Mem0, Deep Agents, AgeMem, ChatGPT Memory, Coding Agent Memory, Autoreason, Helix, MIRIX, SYNAPSE, A-Mem, SSGM
