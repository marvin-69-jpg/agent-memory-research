...
| **Prediction error** | 只在預期不符時更新 | Selective update（ADD/UPDATE/DELETE/NOOP） | 不是所有 input 都該更新記憶 |
...
[[agent-memory]] [[graph-memory]] [[memory-staleness]] [[sleep-time-compute]] [[compiled-truth-pattern]] [[hybrid-search]] [[mem0]] [[multi-scope-memory]] [[memory-evaluation]] [[memory-failure-modes]] [[locomo]] [[agemem]] [[entity-detection]] [[open-questions]] [[synapse]] [[reconsolidation]] [[a-mem]] [[ssgm]]
