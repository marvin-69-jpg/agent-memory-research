...
- Skills 用「fat markdown」定義 — agent 的 playbook 不是 code 而是文件
- 實際規模：10,000+ 檔案、3,000+ 人物 dossier、13 年日曆、280+ 會議逐字稿
...
[[garry-tan]] [[compiled-truth-pattern]] [[hybrid-search]] [[compounding-memory]] [[agent-memory]] [[agent-harness]]
