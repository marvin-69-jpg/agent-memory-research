...
| [[mem1]] | RL 學 constant-size internal state 取代 full context，memory-reasoning 統一 |
| [[memory-r1]] | Two-agent RL memory management，152 QA pairs 訓練，LoCoMo SOTA |
...
| [[apex-mem]] | Append-only temporal property graph，retrieval-time resolution，LOCOMO 88.88% |
